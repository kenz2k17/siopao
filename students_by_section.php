...
<script>
	jQuery(document).ready(function(){
		...
		$('body').removeAttr('style');
			   ...
			   <section class="content-header">
                    <h1>
						Student List of <?php echo $grade; ?>
  ...
  <section class="content">
	<div class="row">
	<div class="col-lg-12">
	<?php include('students_by_section_menu.php'); ?>
	...
	<hr class="hr">
				...
				<a onclick="window.open('export_student_report_by_section.php?sy=<?php echo $sy ?>&grade_id=<?php echo $grade_id; ?>&section_id=<?php echo $section_id; ?>')" class="btn btn-success" href="#"><i class="fa fa-file-excel-o"></i> Export to Excel </a>
					|				
				<a onclick="window.open('student_report_by_section.php?sy=<?php echo $sy ?>&grade_id=<?php echo $grade_id; ?>&section_id=<?php echo $section_id; ?>')" class="btn btn-info" href="#"><i class="fa fa-file-pdf-o"></i> Print</a>
				<hr class="hr">	
