  ...
  <section class="content">
	...
	<hr class="hr">
				...
				<table class="table table-bordered table-condensed" id="data_table">
						...
						?>
								<tr>
									<td class="center"><?php echo $row['tc']; ?></td>
									...
									<td class="center">
										<?php if($user_type == 'Registrar'){ ?>
											<a href="page.php?page=edit_transactions&sy=<?php echo $_GET['sy']; ?>&grade_id=<?php echo $_GET['grade_id']; ?>&id=<?php echo $id; ?>"  class="btn btn-warning btn-block"> <i class="fa fa-edit"></i> Edit   </a>
											<hr class="hr">
										<?php } ?>
