...
<script>
 ...
 <form method="POST" id="form_add">
	<div class="row">
		<div class="col-lg-12">
			<a href="page.php?page=students&sy=<?php echo $sy; ?>&grade_id=<?php echo $_GET['grade_id']; ?>" class="btn btn-success"><i class="fa fa-arrow-left"></i> Back</a>
			<hr class="hr">
		</div>
		<div class="col-lg-6">
<div class="form-horizontal" role="form">
  <div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      <input type="hidden" name="action" value="update_student" class="form-control">
