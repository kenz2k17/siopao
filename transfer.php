...
<div class="form-horizontal" role="form">
  <div class="form-group">
    ...
    <div class="col-sm-9">
      ...
      <input type="hidden" name="status" value="transfer" class="form-control">
 	...
 	jQuery(document).ready(function(){
		jQuery("#grade_id").on('change',function(e){
			...
			var grade_id = $("#grade_id").val();
				$.ajax({
					type: "POST",
					url: "grade_teacher.php",
					data: {grade_id: grade_id},
					success: function(html){
							$(".grade_teacher").html(html);
					}
				});
				...
				<script>
					jQuery(document).ready(function(){
						jQuery("#form_add").submit(function(e){
							...
							$.ajax({
								type: "POST",
								url: "ajax_add.php?students=transfer",
								data: formData,
								success: function(html){
										$('#message').modal("show");
										window.open('enrol_report.php?status=transfer', '_blank');
										var delay = 2000;
